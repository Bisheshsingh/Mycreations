...
ms=mysql.connector.Connect(host="sql12.freemysqlhosting.net", user="sql12373333"
                           ,password="ElBl5HZbiE",database="sql12373333")
mc=ms.cursor()
        ...
        def save_fun():
            ...
            if user_choice >0:
                ...
                try:
                    ...
                    messagebox.showerror("Error!",f"Error due to {e}",self.win)
...
#=================================Calculator Frame============================================
        ...
        self.calc_frame.place(x=585,y=90,width=650,height=295)
        ...
        self.btn7=Button(self.calc_frame,bg="plum",text="7",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn7.grid(row=1,column=0,padx=2,pady=2)
        self.btn7.bind("<Button-1>",press_btn)
        
        self.btn8=Button(self.calc_frame,bg="plum",text="8",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn8.grid(row=1,column=1,padx=2,pady=2)
        self.btn8.bind("<Button-1>",press_btn)

        self.btn9=Button(self.calc_frame,bg="plum",text="9",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn9.grid(row=1,column=2,padx=2,pady=2)
        self.btn9.bind("<Button-1>",press_btn)  
        
        
        self.btnadd=Button(self.calc_frame,bg="plum",text="+",bd=8,width=11,height=1,font=('Arial,15'))
        self.btnadd.grid(row=1,column=3,padx=2,pady=2)
        self.btnadd.bind("<Button-1>",press_btn)  
        
        self.btn4=Button(self.calc_frame,bg="plum",text="4",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn4.grid(row=2,column=0,padx=2,pady=2)
        self.btn4.bind("<Button-1>",press_btn)  
        
        self.btn5=Button(self.calc_frame,bg="plum",text="5",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn5.grid(row=2,column=1,padx=2,pady=2)
        self.btn5.bind("<Button-1>",press_btn)  

        self.btn6=Button(self.calc_frame,bg="plum",text="6",bd=8,width=11,height=1,font=('Arial,15'))
        ...
        self.btnclr=Button(self.calc_frame,bg="plum",text="C",bd=8,width=11,height=1,font=('Arial,15'),command=clr)
        self.btnclr.grid(row=2,column=4,padx=2,pady=2)
        
        self.btnsubtract=Button(self.calc_frame,bg="plum",text="-",bd=8,width=11,height=1,font=('Arial,15'))
        self.btnsubtract.grid(row=2,column=3,padx=2,pady=2)
        self.btnsubtract.bind("<Button-1>",press_btn)  
        
        self.btn1=Button(self.calc_frame,bg="plum",text="1",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn1.grid(row=3,column=0,padx=2,pady=2)
        self.btn1.bind("<Button-1>",press_btn)  
        
        self.btn2=Button(self.calc_frame,bg="plum",text="2",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn2.grid(row=3,column=1,padx=2,pady=2)
        self.btn2.bind("<Button-1>",press_btn)  
        
        self.btn3=Button(self.calc_frame,bg="plum",text="3",bd=8,width=11,height=1,font=('Arial,15'))
        self.btn3.grid(row=3,column=2,padx=2,pady=2)
        self.btn3.bind("<Button-1>",press_btn)  
        
        self.btnmulti=Button(self.calc_frame,bg="plum",text="*",bd=8,width=11,height=1,font=('Arial,15'))
        self.btnmulti.grid(row=3,column=3,padx=2,pady=2)
        self.btnmulti.bind("<Button-1>",press_btn)  
        
        self.btnzero=Button(self.calc_frame,bg="plum",text="0",bd=8,width=11,height=1,font=('Arial,15'))
        self.btnzero.grid(row=4,column=0,padx=2,pady=2)
        self.btnzero.bind("<Button-1>",press_btn)  
        
        self.btnpoint=Button(self.calc_frame,bg="plum",text=".",bd=8,width=11,height=1,font=('Arial,15'))
        self.btnpoint.grid(row=4,column=1,padx=2,pady=2)
        self.btnpoint.bind("<Button-1>",press_btn)  
        
        self.btnclear=Button(self.calc_frame,bg="plum",text="=",bd=8,width=11,height=1,font=('Arial,15'))
        self.btnclear.grid(row=4,column=2,padx=2,pady=2)
        self.btnclear.bind ("<Button-1>",press_btn) 
        
        
        
        self.btndivide=Button(self.calc_frame,bg="plum",text="/",bd=8,width=11,height=1,font=('Arial,15'))
